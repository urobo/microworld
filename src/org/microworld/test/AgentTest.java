...
public class AgentTest {
	...
	/**
	 * Test method for {@link org.microworld.robots.Agent#register(org.microworld.models.Person)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link org.microworld.robots.Agent#updatePosition(org.microworld.models.Location)}.
	 */
	@Test
	public void testUpdatePosition() {
		Log.verbose("django update position", this.agent.getUser().getUsername()+" "+ this.agent.getUser().getPassword() +" "+ this.agent.getUser().getHref());
		...
		assertTrue(result.getHref().equals(this.agent.getUser().getHref()+DycapoGlobalVariables.LOCATION));
		
	}

	/**
	 * Test method for {@link org.microworld.robots.Agent#getPosition(org.microworld.models.Person)}.
	 */
	@Test
